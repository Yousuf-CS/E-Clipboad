...
namespace ClipBoard
{
    ...
    public class Authentication
    {
        ...
        public static DriveService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            ...
            GoogleWebAuthorizationBroker.Folder = EClipboard.cb.LocalTokensPath;
            ...
            try
            {
                ...
                //Console.WriteLine(GoogleWebAuthorizationBroker.Folder); // for testing token storage folder
